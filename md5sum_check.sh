...
md5sum *fq.gz > md5sum/md5sum_copied.txt
...
comm -12 <(awk '{print $1}' md5sum/md5sum_copied.txt | sort) \
         <(awk '{print $1}' md5sum/md5sum_check.txt | sort) \
| wc -l >> ../logs/md5sum.out

echo "over:" >> ../logs/md5sum.out
wc -l md5sum/md5sum_check.txt >> ../logs/md5sum.out

# 4. Listing of the non-similar files
echo "If error, non similar files:" >> ../logs/md5sum.out
comm -23 <(awk '{print $1}' md5sum/md5sum_copied.txt | sort) \
         <(awk '{print $1}' md5sum/md5sum_check.txt | sort) \
| while read md5; dos

    grep "$md5" md5sum/md5sum_copied.txt >> ../logs/md5sum.out
done
